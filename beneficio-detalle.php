...
<?php 
    ...
    $query_blog = "SELECT * FROM tbl_servicios WHERE id= $ID";
    ...
    mysqli_select_db($connect, $database);
    $query_blogUltimos = 'SELECT * FROM tbl_servicios ORDER BY id DESC LIMIT 7';
    ...
    mysqli_select_db($connect, $database);
    $query_blogOtros = 'SELECT * FROM tbl_servicios ORDER BY id DESC LIMIT 7,3';

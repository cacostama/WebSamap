            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="section__content">
                        <h1 class="section__content-title wow fadeInUp" data-wow-duration="1.5s"><br><br>Tenemos un Plan, para cada etapa de Tu vida.
                            <span class="hero-text word d-inline-flex">
                               <!-- <span data-wow-duration="1.1s" data-wow-delay="0.10s" class="letter hero_custom wow fadeInDown">S</span>
                                <span data-wow-duration="1.1s" data-wow-delay="0.25s" class="letter hero_custom wow fadeInDown">A</span>
                                <span data-wow-duration="1.1s" data-wow-delay="0.40s" class="letter hero_custom wow fadeInDown">M</span>
                                <span data-wow-duration="1.1s" data-wow-delay="0.55s" class="letter hero_custom wow fadeInDown">A</span>
                                <span data-wow-duration="1.1s" data-wow-delay="0.70s" class="letter hero_custom wow fadeInDown">P</span>
                                <span data-wow-duration="1.1s" data-wow-delay="0.85s" class="letter hero_custom wow fadeInDown">h</span>
                           		 -->
                            </span>
                        </h1>
                        <p class="fs-4 wow fadeInLeft" data-wow-duration="1.5s">Planes más accesible para vos y tu familia.</p>
                        <a href="<?php echo $URL?>planes/" class="btn_theme mt_40 wow fadeInRight" data-wow-duration="1.5s">CONOCE NUESTROS PLANES</a>
                    </div>
                </div>
                <div class="col-xl-5 offset-xl-1">
                    <div class="hero-area__slider wow fadeInRight" data-wow-duration="1.5s">
                        <div class="banner-slider">
                            <div class="slider slider-hero">
                                <?php do { ?>

                                    <div class="slider-image">
                                        <img src="<?php echo $URL?>documentos/slider/<?php echo $row_slider['imagen']; ?>" alt="Image">
                                    </div> 

                                <?php 
                                    $row_slider = mysqli_fetch_assoc($slider);
                                    } while ($row_slider);   //end horizontal looper 
                                ?>
                            ...
                            <div class="slider slider-nav thumb-image">
                                ...
                                <div class="thumbnail-image">
                                    <div class="thumbImg">
                                        <img src="<?php echo $URL?>documentos/slider/<?php echo $row_slider2['imagen']; ?>" alt="Image">
                                    </div>
                                </div>
                                <?php 
                                    $row_slider2 = mysqli_fetch_assoc($slider2);
                                    } while ($row_slider2);   //end horizontal looper 
                                ?>
            ...
            <div class="row align-items-center gy-3 gy-lg-0">
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="countdown__part wow fadeInUp" data-wow-duration="1.2s">
                        <h3 class="theme_color d-inline-flex align-items-center mb_30"><span class="odometer" data-odometer-final="24"></span><span>/7</span></h3>
                        <div class="fs-4">Atención</div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="countdown__part wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.3s">                            
                        <h3 class="theme_color mb_30"><span class="odometer" data-odometer-final="5000"></span> <span>+</span></h3>
                        <div class="fs-4">Adheridos</div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-lg-3">
                    <div class="countdown__part wow fadeInUp" data-wow-duration="1.2s" data-wow-delay="0.6s">
                        <h3 class="theme_color mb_30"><span class="odometer" data-odometer-final="40"></span></h3>
                ...
                <div class="col-12 col-lg-7">
                    <div class="section__content text-center">
                        ...
                        <div class="section__content-cta customGapThree">
                            ...
                            <a href="#" class="btn_theme btn_light_border wow fadeInRight" data-wow-duration="1.2s">MÁS INFO</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="team__slider">
                        <?php do { ?>
                            <div class="team__slider-card text-center wow fadeInUp" data-wow-duration="1.2s">
                                ...
                                <div class="team__slider-card-info">
                                    <h5 class="text-white"><?php echo$row_medicos['titulo'];?> <?php echo$row_medicos['nombre'];?></h5>
                                    <p class="text-white mb_12"><?php echo$row_medicos['especialidad'];?></p>
                                    <a href="tel:+122-212-2155" class="text-white">Teléfono: (021) 219 6700</a>
                                </div>
                            </div>
                        <?php 
                            $row_medicos = mysqli_fetch_assoc($medicos);

...
if (isset($_SESSION['ADM_Username'])){
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2") && samap_puede_escribir() && samap_csrf_validar()) {
		...
		try {
			...
			$stmt = $conexion->prepare('INSERT INTO tbl_nacionalidad (nacionalidad, bandera) VALUES (?, ?)');
			if ($stmt) {
				$stmt->bind_param('ss', $nacionalidad, $IMAGEN);
				$stmt->execute();
				$stmt->close();
			}
...
<meta http-equiv="Content-Language" content="es"/>
	...
	<title>AGREGAR NACIONALIDAD -  Administrador</title>
							...
							<?php echo samap_csrf_field(); ?>
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nacionalidad" placeholder="" value=""  class="form-control">

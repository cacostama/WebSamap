...
if (isset($_SESSION['ADM_Username'])){
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
		...
		if ($_FILES['imagen']['name'] != "") { 
			...
			move_uploaded_file($_FILES['imagen']['tmp_name'],$rutaMedico.$imagen_real);
			$img_original = "$rutaMedico/".$imagen_real;
...
<meta http-equiv="Content-Language" content="es"/>
	...
	<title>EDITAR MEDICO -  Administrador</title>
						...
						<form class="form-horizontal" action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form2" id="form2">
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="titulo" placeholder="" value="<?php echo $row_medico['titulo']; ?>"  class="form-control">
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="nombre" placeholder="" value="<?php echo $row_medico['nombre']; ?>"  class="form-control">
										</div>
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="especialidad" placeholder="" value="<?php echo $row_medico['especialidad']; ?>"  class="form-control">
										</div>
								...
								<input type="hidden" name="id" value="<?php echo $row_medico['id']; ?>" />

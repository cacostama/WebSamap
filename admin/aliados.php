...
if (isset($_SESSION['ADM_Username'])){
	...
	$query_convenios= "SELECT * FROM tbl_aliados";
    ...
    function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "")) {
	  $deleteSQL = sprintf("DELETE FROM tbl_aliados WHERE id=%s",
	                       GetSQLValueString($_GET['id'], "int"));

	  mysqli_select_db($connect, $database);
	  $Result1 = mysqli_query($connect, $deleteSQL) or die(mysqli_error());

	  echo"<script>alert('ALIADO ELIMINADO CORRECTAMENTE!'); window.location.href=\"".$URL."admin/aliados/\"</script>";
	}
			...
			<section class="main-content">
				...
				<div class="row">
						<div class="panel panel-default">
							<div class="panel-heading"><a href="<?php echo $URL?>admin/agregar-aliado.php" class="btn btn-primary" >Agregar Aliado</a></div>
									...
									<tbody>
	                                 <?php do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/aliados.php?id=<?php echo $row_convenios['id']; ?>&borrar=si"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

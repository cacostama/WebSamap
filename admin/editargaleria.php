...
if (isset($_SESSION['ADM_Username'])){
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
	    ...
	    //--------FIN IMAGEN1---------//
			...
			echo"<script>alert('GALERIA MODIFICADA CORRECTAMENTE!'); window.location.href=\"".$URL."admin/galeria/\"</script>";
...
<meta http-equiv="Content-Language" content="es"/>
	...
	<title>AGREGAR GALERÍA -  Administrador</title>
						...
						<form class="form-horizontal" action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form2" id="form2">
								...
								<fieldset>
									<div class="form-group">
										<label class="col-lg-2 control-label">Nombre de la galería</label>
										<div class="col-lg-10">
											<input type="text" name="nombre" placeholder="" value="<?php echo $row_galeria['nombre']; ?>"  class="form-control">
								...
								<input type="hidden" name="id" value="<?php echo $row_galeria['id']; ?>" />

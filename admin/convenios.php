...
if (isset($_SESSION['ADM_Username'])){
	...
	$query_convenios= "SELECT * FROM tbl_convenios WHERE deleted_at IS NULL";
    ...
    function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "") && samap_puede_escribir()) {
	  ...
	  echo"<script>alert('CONVENIO ELIMINADO CORRECTAMENTE!'); window.location.href=\"".$URL."admin/convenios/\"</script>";
	}
			...
			<section class="main-content">
				...
				<div class="row">
						<div class="panel panel-default">
							<div class="panel-heading"><a href="<?php echo $URL?>admin/agregar-convenio.php" class="btn btn-primary" >Agregar Convenio</a></div>
									...
									<tbody>
	                                 <?php if ($totalRows_convenios > 0) { do { ?>
										...
										<tr class="gradeX">
											...
											<td><?php echo $row_convenios['ciudad'];?></td>
											<td><?php echo $row_convenios['titulo'];?></td>
											
											<td><img  height="30px" src="<?php echo $URL?>documentos/<?php echo $row_convenios['imagen']; ?>" alt=""/></td>
											
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/editarconvenio/cod/<?php echo $row_convenios['id']; ?>/"><img width="20px" src="<?php echo $URL?>admin/app/img/editar.png"alt=""/></a></div></td>

											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/convenios.php?id=<?php echo $row_convenios['id']; ?>&borrar=si" onclick="return confirm('¿Querés eliminar este registro? Dejará de mostrarse en el sitio web.');"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

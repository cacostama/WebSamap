...
if (isset($_SESSION['ADM_Username'])){
	...
	$query_convenios= "SELECT * FROM tbl_convenios";
    ...
    function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "")) {
	  $deleteSQL = sprintf("DELETE FROM tbl_convenios WHERE id=%s",
									...
									<tbody>
	                                 <?php do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/convenios.php?id=<?php echo $row_convenios['id']; ?>&borrar=si"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

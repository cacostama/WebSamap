...
if (isset($_SESSION['ADM_Username'])){
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "")) {
	  ...
	  $deleteSQL = sprintf("DELETE FROM tbl_apoyan WHERE id=%s",
...
<meta http-equiv="Content-Language" content="es"/>
	...
	<title>APOYAN -  Administrador</title>
			...
			<section class="main-content">
				...
				<div class="row">
																<div class="panel panel-default">
																	<div class="panel-heading"><a href="<?php echo $URL?>admin/agregar-apoyan.php" class="btn btn-primary" >Agregar</a></div>
																			...
																			<tbody>
                                                                             ...
                                                                             ?>
																				...
																				<tr class="gradeX">
																					...
																					<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/editarapoyan/cod/<?php echo $row_sponsor['id']; ?>/"><img width="20px" src="<?php echo $URL?>admin/app/img/editar.png"alt=""/></a></div></td>
																					<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/apoyan.php?id=<?php echo $row_sponsor['id']; ?>&borrar=si&csrf_token=<?php echo urlencode(samap_csrf_valor()); ?>" onclick="return confirm('¿Querés eliminar este apoyo? No se puede deshacer.');"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

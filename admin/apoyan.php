...
if (isset($_GET['reordenar']) && $_GET['reordenar'] === 'si' && samap_puede_escribir() && samap_csrf_validar()) {
	...
	$btn_agregar_url     = 'admin/agregar-apoyan.php';
	$edit_url_pattern    = 'admin/editarapoyan/cod/{id}/';
	...
	$columns = [
		...
		['th' => 'URL',    'td_html' => function($r) { return '<td>' . htmlspecialchars((string)($r['URL'] ?? ''), ENT_QUOTES, 'UTF-8') . '</td>'; }],

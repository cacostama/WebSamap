									...
									<tbody>
	                                 <?php if ($totalRows_medicos > 0) { do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/medicos.php?id=<?php echo $row_medicos['id']; ?>&borrar=si&csrf_token=<?php echo urlencode(samap_csrf_valor()); ?>" onclick="return confirm('¿Querés eliminar este registro? Dejará de mostrarse en el sitio web.');"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

    ...
    function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "")) {
	  ...
	  echo"<script>alert('SERVICIO ELIMINADO CORRECTAMENTE!'); window.location.href=\"".$URL."admin/medicos/\"</script>";
	}
									...
									<tbody>
	                                 <?php do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/medicos.php?id=<?php echo $row_medicos['id']; ?>&borrar=si"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>

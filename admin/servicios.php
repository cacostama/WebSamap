    ...
    function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "")
{
	...
	$edit_url_pattern    = 'admin/editarservicio/cod/{id}/';
	$delete_url_pattern  = 'admin/servicios.php?id={id}&borrar=si&csrf_token={csrf}';
	$delete_confirm      = '¿Querés eliminar este servicio? Dejará de mostrarse en el sitio web.';
	$empty_message       = 'Todavía no hay servicios cargados.';
	$slug                = 'servicios';
	...
	$columns = [
		...
		['th' => 'Imagen',   'td_html' => function($r) use ($URL_BASE) {
			...
			return '<td><img height="30px" src="' . htmlspecialchars($URL_BASE, ENT_QUOTES, 'UTF-8') . 'documentos/servicios/' . $img . '" alt=""/></td>';
		}],
	];
	...
	<section class="wrapper">
		...
		<section>
			...
			<section class="main-content">
				...
				<?php $papelera_activa = $papelera; if (isset($servicios)) { $rows = $servicios; include 'partials/tabla-searchable.php'; } ?>
			</section>

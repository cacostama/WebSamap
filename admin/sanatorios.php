									...
									<tbody>
	                                 <?php do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/sanatorios.php?id=<?php echo $row_sanatorios['id']; ?>&borrar=si"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>
											
										</tr>
	                                  <?php
	                                        $row_sanatorios = mysqli_fetch_assoc($sanatorios);
	                                        } while ($row_sanatorios);   //end horizontal looper 
	                                    ?>  
									</tbody>
								</table>
							</div>

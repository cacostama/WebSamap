...
if (isset($_SESSION['ADM_Username'])){
	...
	if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
	    ...
	    //--------FIN IMAGEN1---------//
			...
			echo"<script>alert('CIUDAD INSETADA CORRECTAMENTE!'); window.location.href=\"".$URL."admin/ciudad/\"</script>";
...
<meta http-equiv="Content-Language" content="es"/>
	...
	<title>AGREGAR CIUDAD -  Administrador</title>
						...
						<form class="form-horizontal" action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form2" id="form2">
								...
								<fieldset>
									<div class="form-group">
										<label class="col-lg-2 control-label">Nombre Ciudad</label>
										<div class="col-lg-10">
								...
								<fieldset>
									<div class="form-group">
										...
										<div class="col-sm-10">
											<select name="estado" id="estado" style="width: 255px;" required>

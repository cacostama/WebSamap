...
if (isset($_SESSION['ADM_Username'])){
    ...
    if ((isset($_GET['borrar'])) && ($_GET['id'] != "") && samap_puede_escribir()) {
	  ...
	  echo"<script>alert('PLAN ELIMINADO CORRECTAMENTE!'); window.location.href=\"".$URL."admin/ciudad/\"</script>";
	}
			...
			<section class="main-content">
				...
				<div class="row">
						<div class="panel panel-default">
							<div class="panel-heading"><a href="<?php echo $URL?>admin/agregar-ciudad.php" class="btn btn-primary" >Agregar Ciudad</a></div>
							<div class="panel-body">
								<table id="datatable1" class="table table-striped table-hover">
									...
									<tbody>
	                                 <?php if ($totalRows_ciudad > 0) { do { ?>

										<tr class="gradeX">
											<td><?php echo $row_ciudad['id'];?></td>
											<td><?php echo $row_ciudad['nombre'];?></td>
											<td>
												
												<?php if($row_ciudad['estado']==1){?>
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/editarciudad/cod/<?php echo $row_ciudad['id']; ?>/"><img width="20px" src="<?php echo $URL?>admin/app/img/editar.png"alt=""/></a></div></td>

											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/ciudad.php?id=<?php echo $row_ciudad['id']; ?>&borrar=si" onclick="return confirm('¿Querés eliminar este registro? Dejará de mostrarse en el sitio web.');"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>
											
										</tr>
	                                  <?php
	                                        $row_ciudad = mysqli_fetch_assoc($ciudad);
	                                        } while ($row_ciudad); } else { ?><tr><td colspan="7" style="text-align:center;color:#888;padding:18px;">Todavía no hay registros cargados.</td></tr><?php }   //end horizontal looper 
	                                    ?>  
									</tbody>
								</table>
							</div>

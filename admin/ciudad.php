									...
									<tbody>
	                                 <?php do { ?>
										...
										<tr class="gradeX">
											...
											<td width="20px"><div align="center"><a href="<?php echo $URL?>admin/ciudad.php?id=<?php echo $row_ciudad['id']; ?>&borrar=si"><img width="20px" src="<?php echo $URL?>admin/app/img/borrar.png"alt=""/></a></div></td>
